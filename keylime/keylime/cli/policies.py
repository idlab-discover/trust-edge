...
def process_policy(args: ArgsType, mb_refstate_file=None) -> Tuple[Dict[str, Any], Optional[str], str, Optional[str], str, str]:
    tpm_policy_str = "{}"
    runtime_policy_name = ""
    mb_refstate = None
    ...
    if "mb_refstate" in args and args["mb_refstate"] is not None or mb_refstate_file is not None:
        ...
        elif mb_refstate_file is not None:
            #raw json is passed instead of file path
            mb_refstate_data = mba.policy_load(None, mb_refstate_file)
        else:
